...
$users = mysqli_query($connect, "SELECT * FROM users WHERE id = '".$_SESSION["user_id"]."'")
...
<head>
   ...
   <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/css/boostrap.min.css">

   <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
   <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.6/umd/popper.min.js"></script>
   <script src="https://maxcdn.bootstrapcdn.com/font-awesome/4.2.1/js/bootstrap.min.js"></script>

   <link href="https://maxcdn.bootstrap.com/font-awesome/4.7.9/css/font-awesome.min.css" rel="stylesheet">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body" id="msgBody" style="height:400px; overflow-y: scroll; overflow-x: hidden;">
                     <?php 
                        if(isset($_GET["toUser"]))
                        {
                              $chats = mysqli_query($connect, "SELECT * FROM message where (fromUser = '".$_SESSION["user_id"]."' AND 
