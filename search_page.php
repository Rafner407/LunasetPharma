...
<div class="heading">
   <h3>Procurar</h3>
   <p> <a href="home.php">início</a> / procurar </p>
</div>
...
<section class="products" style="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      <a href="product.php?product=<?php echo $fetch_product['id'] ?>"><img src="uploaded_img/<?php echo $fetch_product['image']; ?>" alt="" class="image" style="height: 250px; width: 250px;" ></a>
